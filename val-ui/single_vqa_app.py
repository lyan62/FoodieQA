...
with open("single_vqa_config.yaml", "r") as file:
...
def get_vqa_data(start_index=0):
    ...
    return image_data_list, cur_data
...
def handle_user_input():
    ...
    image_qa = {
        ...
        "images":vqa_data[current_index]["food_meta"]["food_file"],
        "food_file":vqa_data[current_index]["food_meta"]} 
