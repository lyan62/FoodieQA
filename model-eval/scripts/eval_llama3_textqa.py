...
if __name__ == "__main__":
    ...
    argparser.add_argument("--model_name", default="shenzhi-wang/Llama3-8B-Chinese-Chat")  # shenzhi-wang/Llama3-8B-Chinese-Chat#meta-llama/Llama-2-70b, meta-llama/Meta-Llama-3-8B-Instruct
